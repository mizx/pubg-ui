...
// OTHER
export const ANNOUNCEMENT_REQUEST = 'APP::ANNOUNCEMENT_REQUEST';
export type ANNOUNCEMENT_REQUEST = typeof ANNOUNCEMENT_REQUEST;

export const ANNOUNCEMENT_SUCCESS = 'APP::ANNOUNCEMENT_SUCCESS';
export type ANNOUNCEMENT_SUCCESS = typeof ANNOUNCEMENT_SUCCESS;

export const ANNOUNCEMENT_FAILURE = 'APP::ANNOUNCEMENT_FAILURE';
export type ANNOUNCEMENT_FAILURE = typeof ANNOUNCEMENT_FAILURE;
