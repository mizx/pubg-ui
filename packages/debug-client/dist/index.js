...
var sendError = function (message, level) { return __awaiter(_this, void 0, void 0, function () {
    var options, body;
...
console.log = function (message) {
    ...
    ref.log.apply(ref, [message].concat(optionalParams));
...
console.error = function (message) {
    ...
    ref.error.apply(ref, [message].concat(optionalParams));
...
console.warn = function (message) {
    ...
    ref.warn.apply(ref, [message].concat(optionalParams));
